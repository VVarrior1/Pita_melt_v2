      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center mb-2">
            <button
              onClick={() => router.back()}
              className="flex items-center text-white hover:text-gray-200 transition-colors mr-6 bg-black bg-opacity-10 backdrop-blur-sm rounded-lg px-4 py-2 hover:bg-opacity-20"
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-4 bg-gray-50 border-2 rounded-xl text-gray-800 focus:border-orange-500 focus:ring-4 focus:ring-orange-200 focus:bg-white transition-all duration-200 ${
                      ...
                      <div className="relative">
                        ...
                        <div className={`w-6 h-6 rounded-lg border-2 transition-all duration-200 flex items-center justify-center ${
                          marketingConsent.email 
                            ...
                            : 'border-gray-400 hover:border-orange-500 group-hover:shadow-md'
                        }`}>
                          {marketingConsent.email && (
