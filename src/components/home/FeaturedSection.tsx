...
export interface FeaturedItem {
  ...
  description: string;
  priceDisplay: string;
  /** Optional emoji to represent the item visually without photos */
  iconEmoji?: string;
  /** Tailwind gradient classes, e.g., 'from-orange-500 to-red-500' */
  gradient?: string;
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((item) => (
            ...
            >
              <div className={`relative h-32 flex items-center justify-center bg-gradient-to-br ${item.gradient ?? 'from-gray-600 to-gray-700'} opacity-90`}>
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#f17105] font-bold">
                    {item.priceDisplay}
                  </span>
